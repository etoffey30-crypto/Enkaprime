        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-700 leading-relaxed text-base sm:text-lg mb-6">{settings.about_extended || 'Founded on the principle that sustainable organisational performance depends on strong systems rather than skills development alone, we combine practical implementation expertise with structured capacity-building methodologies.'}</p>
